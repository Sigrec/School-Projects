...
if curMode == "GROUND":
	time.sleep(2)
	if wayPointCount > 0: # example if else for determing challenge not functional right now
    ...
    ArmDrone()
    DroneTakeOff(targetAltitude)
    homeLocation = vehicle.location.global_relative_frame
    vehicle.airspeed = 4

    #Fly North 30 Meters in 5 seconds
    ...
    while vehicle.mode.name == "GUIDED":
        ...
        if distanceTraveled >= targetMeters * 0.99:
	...
	# Fly North and up
	FrameVelocityControl(2, 0, -0.5, 5)
